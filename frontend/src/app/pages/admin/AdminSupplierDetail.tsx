    ...
    if (loading) {
        return (
            <div style={{ padding: '60px 24px', textAlign: 'center' }}>
                <div className={styles['admin-spinner']} style={{ margin: '0 auto 16px' }}></div>
                <div style={{ color: 'var(--admin-text-sub, #64748b)', fontWeight: 600 }}>
                    {t('loading_seller_profile') || 'Loading Seller Profile...'}
                </div>
            </div>
        );
    }
